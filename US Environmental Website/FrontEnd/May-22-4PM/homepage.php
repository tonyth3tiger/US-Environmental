...
$query = "select location_id,incident_description,incident_id,categories_id  from incidents";
...
echo '  <h1 style="float:left">Recent Posts</h1>';
...
echo '            <th style width="12%">Issue Category';
