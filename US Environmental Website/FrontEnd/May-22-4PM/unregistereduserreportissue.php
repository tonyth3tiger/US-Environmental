...
alert("Please login to continue. If not registered, please register!!");
}
</script>
...
<img class="navbar-brand" src="https://github.com/csc648-sp18/csc648-team09/blob/master/US%20Environmental%20Website/FrontEnd/Logo/newLogoWithTitle.png?raw=true"></img>
        <li class="active"><a href="unregistereduserhomepage.php">Home</a></li>
...
<p>See an issue in park... Post it, Check the Status, Enjoy your park time</p> 
 ...
 <!-- Search icon button -->
      ...
      <h1>Post an Issue</h1>
      <!--Issue form -->
      <form class="form-horizontal" id="usrform"  >
        <!-- Park input field -->
 ...
 <div class="form-group">
        ...
        <button id="save" type="submit" class="btn btn-primary btn-lg"  onclick="errormessage()">Save</button>
</div>
      </form>
