...
//$getcategoryid = mysqli_query($con,"select categories_id from categories where categories_name = '$issue'");
//echo $getcategoryid;
$query = "insert into incidents(incident_date,incident_description,incident_photo_full_link,location_id,categories_id,reporting_user_id) values(NOW(),'$desc','$databasefilepath','$locationid','$categoryid','$userid')";
